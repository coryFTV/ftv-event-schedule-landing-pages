...
const MovieIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 6C2 4.89543 2.89543 4 4 4H20C21.1046 4 22 4.89543 22 6V18C22 19.1046 21.1046 20 20 20H4C2.89543 20 2 19.1046 2 18V6Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
...
const TVSeriesIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="2" y="5" width="20" height="15" rx="2" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    <path d="M8 2L12 5L16 2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M7 12V15L11 13.5L7 12Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
          ...
          <ul className="nav-links">
            <li>
              <Link to="/movies" className={isActive('/movies') ? 'active' : ''}>
                <span className="nav-icon"><MovieIcon /></span>
                <span>All Movies</span>
              </Link>
            </li>
            <li>
              <Link to="/series" className={isActive('/series') ? 'active' : ''}>
                <span className="nav-icon"><TVSeriesIcon /></span>
                <span>TV Series</span>
              </Link>
            </li>
            <li className="dropdown">
              ...
              <ul className={`dropdown-menu ${showEntertainmentDropdown ? 'open' : ''}`}>
                <li><Link to="/movies/action" className={isActive('/movies/action') ? 'active' : ''}>Action</Link></li>
                <li><Link to="/movies/comedy" className={isActive('/movies/comedy') ? 'active' : ''}>Comedy</Link></li>
                <li><Link to="/movies/drama" className={isActive('/movies/drama') ? 'active' : ''}>Drama</Link></li>
              </ul>
            </li>
          </ul>
        </div>
