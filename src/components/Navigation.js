...
const TeamsIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M17 20H22V18C22 16.3431 20.6569 15 19 15C18.0444 15 17.1931 15.4468 16.6438 16.1429"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    ...
    />
    <path
      d="M7 20H2V18C2 16.3431 3.34315 15 5 15C5.95561 15 6.80686 15.4468 7.35625 16.1429"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M5 11C3.34315 11 2 9.65685 2 8C2 6.34315 3.34315 5 5 5C6.65685 5 8 6.34315 8 8C8 9.65685 6.65685 11 5 11Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Add new icons for Movies and TV Series
const MovieIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
    ...
    <path d="M6 4V10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
...
function Navigation() {
  ...
  const [showEntertainmentDropdown, setShowEntertainmentDropdown] = useState(false);
  ...
  const toggleEntertainmentDropdown = () => {
    setShowEntertainmentDropdown(!showEntertainmentDropdown);
  };
    ...
    <>
      ...
      <nav className={`sidebar-nav ${mobileMenuOpen ? 'open' : ''}`}>
        <div className="logo">
          <Link to="/">
            <img
              src="https://variety.com/wp-content/uploads/2024/03/Fubo-logo.png?w=1000&h=667&crop=1"
              alt="Fubo Logo"
          ...
          <ul className="nav-links">
            <li className="dropdown">
              ...
              <ul className={`dropdown-menu ${showSportsDropdown ? 'open' : ''}`}>
                <li>
                  <Link to="/sport/mlb" className={isActive('/sport/mlb') ? 'active' : ''}>
                    MLB
                  </Link>
                </li>
                <li>
                  <Link to="/sport/soccer" className={isActive('/sport/soccer') ? 'active' : ''}>
                    Soccer
                  </Link>
                </li>
                <li>
                  <Link to="/sport/nfl" className={isActive('/sport/nfl') ? 'active' : ''}>
                    NFL
                  </Link>
                </li>
                <li>
                  <Link to="/sport/nba" className={isActive('/sport/nba') ? 'active' : ''}>
                    NBA & WNBA
                  </Link>
                </li>
                <li>
                  <Link to="/sport/nhl" className={isActive('/sport/nhl') ? 'active' : ''}>
                    NHL
                  </Link>
                </li>
                <li>
                  <Link
                    to="/sport/college-basketball"
                    className={isActive('/sport/college-basketball') ? 'active' : ''}
                  >
                    College Basketball
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className={isActive('/sport/college-football') ? 'active' : ''}
                  >
                    College Football
                  </Link>
                </li>
                <li>
                  <Link to="/sport/canada" className={isActive('/sport/canada') ? 'active' : ''}>
                    Canada - Sports
                  </Link>
                </li>
                <li>
                  <Link to="/sport/cricket" className={isActive('/sport/cricket') ? 'active' : ''}>
                    Cricket
                  </Link>
                </li>
              </ul>
        ...
        <div className="nav-section">
          <div className="nav-section-title">ENTERTAINMENT</div>
          <ul className="nav-links">
            <li>
            ...
            <li className="dropdown">
              <button
                className={`dropdown-button ${showEntertainmentDropdown ? 'active' : ''}`}
                onClick={toggleEntertainmentDropdown}
                aria-expanded={showEntertainmentDropdown}
              >
                <span>
                  <span className="nav-icon">
                    <MovieIcon />
              ...
              <ul className={`dropdown-menu ${showEntertainmentDropdown ? 'open' : ''}`}>
                <li>
                  <Link to="/movies/action" className={isActive('/movies/action') ? 'active' : ''}>
                    Action
                  </Link>
                </li>
                <li>
                  <Link to="/movies/comedy" className={isActive('/movies/comedy') ? 'active' : ''}>
                    Comedy
                  </Link>
                </li>
                <li>
                  <Link to="/movies/drama" className={isActive('/movies/drama') ? 'active' : ''}>
                    Drama
                  </Link>
                </li>
              </ul>
